    ...
    <div className="shadow-lg bg-white h-[440px] rounded-[20px] py-[19px] px-[15px]">
      ...
      <div className="mt-7">
        ...
        <div className="flex justify-between items-center border-b-2 last:border-b-0 py-3 cursor-pointer">
          ...
          <div>
            <button className="w-[87px] h-[30px] bg-[#5F35F5] border-0 font-Poppins text-[20px] hover:bg-red-500 transition-all hover:text-white text-white rounded-[5px]">Accept</button>
          </div>
        </div>
